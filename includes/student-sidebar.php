...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="pay.php"
        aria-expanded="false"><i class="fas fa-bed"></i><span
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="notice_view.php"
        aria-expanded="false"><i class="fas fa-cogs"></i><span
        class="hide-menu">View notices</span></a></li>
