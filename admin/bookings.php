    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div id="contact-error" style="display:none; color:red;">Please enter a 10-digit number for contact number.</div>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <div id="econtact-error" style="display:none; color:red;">Please enter a 10-digit number for emergency contact number.</div>
            </div>
        </div>
    </div>
</div>
...
<script>
    function validateNumbers() {
        ...
        var econtactError = document.getElementById('econtact-error');
        ...
        if (econtact.length !== 10 && econtact.length > 0) {
            econtactError.style.display = 'block';
        } else {
            econtactError.style.display = 'none';
        }
    }
