...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="notice.php"
        aria-expanded="false"><i class="fas fa-book"></i><span
        class="hide-menu">Notice</span></a></li>

        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="view_notices.php"
        aria-expanded="false"><i class="fas fa-book"></i><span
        class="hide-menu">View_notice</span></a></li>

        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="std_report.php"
        aria-expanded="false"><i class="fas fa-book"></i><span
        class="hide-menu">Student_Report</span></a></li>
