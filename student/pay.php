    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                                ...
                                <table id="zctb" class="table table-striped table-bordered no-wrap">
                                    <tbody>
                                        ...
                                        <?php
                                            ...
                                            $dr = $row->duration;
                                            $fpm = $row->feespm;
                                            $total_fee = ($row->foodstatus == 1) ? (($row->feespm + 211) * $dr) : ($dr * $row->feespm);
                                            ?>
                                            <tr>
                                                <td colspan="6"><b>Total Fee (<?php echo $dr; ?> months): $<?php echo $total_fee; ?></b></td>
                                            </tr>
                                        <?php
                                            $cnt=$cnt+1;
                                        } ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <button type="button" class="btn btn-primary btn-lg btn-block"><a href="http://localhost/HostelManagement-PHP/stripe/">Pay now</a></button>
                    </div>
                </div>
                <!-- End Payment Button -->
